...
mod tests {
    ...
    fn main() {
        ...
        assert_eq!(chain.get_contract(), "5FfRtDtpS3Vcr7BTChjPiQNrcAKu3VLv4E1NGF6ng6j3ZopJ");
        assert_eq!(chain.get_tld(), "azero");

        let chain = Chain::AzeroTest;
        assert_eq!(chain.get_url(), "wss://ws.test.azero.dev:443");
        assert_eq!(chain.get_contract(), "5HXjj3xhtRMqRYCRaXTDcVPz3Mez2XBruyujw6UEkvn8PCiA");
